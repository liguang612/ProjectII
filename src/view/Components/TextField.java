...
public class TextField extends JTextField {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (!isOpaque()) {
            ...
            // Color.decode("#2193b0"), height, width, Color.decode("#6dd5ed"));
        ...
        if (hint != null) {
            if (this.getText().isEmpty()) {
                ...
                g2d.setFont(Constants.getFont(FontType.ROBOTO_REGULAR).deriveFont(Font.ITALIC)
                        .deriveFont((float) hintSize));
