...
public class ResultItem extends RoundedPanel {
  public ResultItem(Attempt attempt) {
    ...
    add(new Column(0,
        new Column(10,
            new Row(0, new JLabel("<hmtl><b>" + exam.getName() + "</b></html>"), Box.createHorizontalGlue()),
            new Row(12,
                new JLabel("Tổng điểm: " + exam.getTotal(), new ImageIcon(Constants.imagePath + "ic_medal.png"),
                    JLabel.LEFT),
                new JLabel("Thời lượng: " + (exam.getDuration() / 60) + " phút",
                    new ImageIcon(Constants.imagePath + "ic_medal.png"),
                    JLabel.LEFT),
