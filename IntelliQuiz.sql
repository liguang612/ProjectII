...
SELECT * FROM EXAM INNER JOIN (SELECT ID, [NAME], SCHOOL FROM ACCOUNT) AS TEACHER ON EXAM.TEACHER = TEACHER.ID WHERE EXAM.[NAME] LIKE 'thi' OR [DESCRIPTION] LIKE 'thi' OR [SUBJECT] LIKE 'thi'