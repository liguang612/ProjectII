...
ALTER TABLE ACCOUNT ADD CONSTRAINT check_phonenumber CHECK (PHONENUMBER NOT LIKE '%[0-9]%')
ALTER TABLE ACCOUNT ADD CONSTRAINT unique_phonenumber UNIQUE(PHONENUMBER)
